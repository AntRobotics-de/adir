...
#include <adir_ros_can_interfaces/msg/frame.hpp>
#include <adir_can_commands_interfaces/msg/stamped_int32.hpp>
...
private:
    ...
    rclcpp::Publisher<adir_ros_can_interfaces::msg::Frame>::SharedPtr can_pub;
    rclcpp::Service<odometry_interfaces::srv::ResetOdometry>::SharedPtr serviceResetOdometry;

    typedef adir_can_commands_interfaces::msg::StampedInt32 StampedInt32;
